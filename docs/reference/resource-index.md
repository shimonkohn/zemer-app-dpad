...
| --- | ---: | --- | --- |
| `app/src/main/res/drawable/account.xml` | 9 lines | `vector` |  |
...
| `app/src/main/res/drawable/arrow_top_left.xml` | 9 lines | `vector` |  |
| `app/src/main/res/drawable/arrow_upward.xml` | 9 lines | `vector` |  |
...
| `app/src/main/res/drawable/grid_view.xml` | 9 lines | `vector` |  |
| `app/src/main/res/drawable/hide_image.xml` | 9 lines | `vector` |  |
...
| `app/src/main/res/drawable/library_music_filled.xml` | 16 lines | `vector` |  |
...
| `app/src/main/res/drawable/radio_button_unchecked.xml` | 9 lines | `vector` |  |
| `app/src/main/res/drawable/remove.xml` | 9 lines | `vector` |  |
| `app/src/main/res/drawable/repeat.xml` | 9 lines | `vector` |  |
| `app/src/main/res/drawable/repeat_on.xml` | 9 lines | `vector` |  |
| `app/src/main/res/drawable/repeat_one.xml` | 9 lines | `vector` |  |
...
| `app/src/main/res/drawable/subscribe.xml` | 9 lines | `vector` |  |
| `app/src/main/res/drawable/subscribed.xml` | 9 lines | `vector` |  |
...
| Path | Lines/bytes | XML root | Resource names / metadata |
| --- | ---: | --- | --- |
| `app/src/main/res/layout/widget_loading.xml` | 45 lines | `LinearLayout` |  |

## `mipmap-anydpi-v26` (2 paths)
...
| Path | Lines/bytes | XML root | Resource names / metadata |
| --- | ---: | --- | --- |
| `app/src/main/res/mipmap-hdpi/ic_launcher.webp` | 730 bytes | `` |  |
| `app/src/main/res/mipmap-hdpi/ic_launcher_foreground.webp` | 744 bytes | `` |  |
| `app/src/main/res/mipmap-hdpi/ic_launcher_round.webp` | 1610 bytes | `` |  |

## `mipmap-mdpi` (3 paths)

| Path | Lines/bytes | XML root | Resource names / metadata |
| --- | ---: | --- | --- |
| `app/src/main/res/mipmap-mdpi/ic_launcher.webp` | 534 bytes | `` |  |
| `app/src/main/res/mipmap-mdpi/ic_launcher_foreground.webp` | 432 bytes | `` |  |
| `app/src/main/res/mipmap-mdpi/ic_launcher_round.webp` | 1126 bytes | `` |  |

## `mipmap-xhdpi` (4 paths)

| Path | Lines/bytes | XML root | Resource names / metadata |
| --- | ---: | --- | --- |
| `app/src/main/res/mipmap-xhdpi/ic_launcher.webp` | 914 bytes | `` |  |
| `app/src/main/res/mipmap-xhdpi/ic_launcher_foreground.webp` | 922 bytes | `` |  |
| `app/src/main/res/mipmap-xhdpi/ic_launcher_round.webp` | 2204 bytes | `` |  |
| `app/src/main/res/mipmap-xhdpi/tv_banner.png` | 2120 bytes | `` |  |

## `mipmap-xxhdpi` (3 paths)

| Path | Lines/bytes | XML root | Resource names / metadata |
| --- | ---: | --- | --- |
| `app/src/main/res/mipmap-xxhdpi/ic_launcher.webp` | 1344 bytes | `` |  |
| `app/src/main/res/mipmap-xxhdpi/ic_launcher_foreground.webp` | 1472 bytes | `` |  |
| `app/src/main/res/mipmap-xxhdpi/ic_launcher_round.webp` | 3556 bytes | `` |  |

## `mipmap-xxxhdpi` (3 paths)

| Path | Lines/bytes | XML root | Resource names / metadata |
| --- | ---: | --- | --- |
| `app/src/main/res/mipmap-xxxhdpi/ic_launcher.webp` | 1942 bytes | `` |  |
...
| `app/src/main/res/values/strings.xml` | 560 lines | `resources` | home, back_to_top, songs, artists, kid_zone, albums, playlists, n_selected, history, stats, mood_and_genres, account, quick_picks, featured_playlists, quick_picks_empty, forgotten_favorites, keep_listening, for_the_kids, your_youtube_playlists, new_release_albums, … +437 more |
